...
<style>
  ...
  .card-icon.blue { background: linear-gradient(135deg, #3B82F6 0%, #1E9BCF 100%); }
  ...
  .btn-primary { display: flex; align-items: center; justify-content: center; background: linear-gradient(135deg, #F97316 0%, #FF6A3D 100%); color: white; border: none; }
