...
<header class="header">
  ...
  {#if isMobileMenuOpen}
    <div class="mobile-menu">
      {#if userState.value}
          {#each appLinks as link}
             <a href={link.href} class="mobile-link" onclick={toggleMenu}>{link.name}</a>
          {/each}
          <div class="divider"></div>
          <button onclick={() => { logout(); toggleMenu(); }} class="mobile-link text-red">Logout</button>
      {:else}
          {#each publicLinks as link}
             <a href={link.href} class="mobile-link" onclick={toggleMenu}>{link.name}</a>
          {/each}
          <div class="divider"></div>
          <a href="/register" class="btn-primary mobile-btn" onclick={toggleMenu}>Get Started Free</a>
      {/if}
    </div>
  {/if}
</header>
