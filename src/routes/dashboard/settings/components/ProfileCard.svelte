...
<style>
  ...
  .card-icon.orange { background: linear-gradient(135deg, var(--orange, #FF6A3D) 0%, #FF6A3D 100%); }
  ...
  .form-group input:focus { outline: none; border-color: var(--orange, #FF6A3D); box-shadow: 0 0 0 3px rgba(255, 127, 80, 0.1); }
  ...
  .upgrade-link-btn { background: none; border: none; color: var(--orange, #FF6A3D); font-size: 14px; font-weight: 600; cursor: pointer; padding: 0; text-decoration: none; }
  ...
  .progress-fill { height: 100%; background: var(--green, #22C55E); border-radius: 4px; transition: width 0.3s; }
  .progress-fill.warning { background: #F59E0B; }
  .btn-secondary { width: 100%; padding: 14px; border-radius: 10px; font-weight: 600; cursor: pointer; transition: all 0.2s; font-size: 15px; background: white; color: #374151; border: 2px solid #E5E7EB; }
  .btn-secondary:hover { border-color: var(--orange, #FF6A3D); color: var(--orange, #FF6A3D); }
</style>