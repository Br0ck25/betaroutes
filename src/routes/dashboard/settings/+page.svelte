...
Estimated Deduction: ${formatCurrency(totalMiles * 0.70)}
...
Mileage Deduction:   ${formatCurrency(totalMiles * 0.70).padStart(12)}
Business Expenses:   ${formatCurrency(grandTotal).padStart(12)}
                     ${'─'.repeat(12)}
Total Deductions:    ${formatCurrency((totalMiles * 0.70) + grandTotal).padStart(12)}
...
Option 1: Standard Mileage Rate ($0.70/mile for 2025)
  ✓ Deduct: Mileage only
...
`;
  ...
  async function exportTaxBundlePDF() {
    ...
    const warning2 = 'If using standard mileage ($0.70/mi), you CANNOT deduct fuel, maintenance, or repairs.';
    ...
    doc.setFontSize(10);
    doc.setFont(undefined, 'bold');
    doc.text('2025 IRS Rate', 14 + boxWidth + (boxWidth - 4) / 2, boxY + 12, { align: 'center' });
    doc.setFontSize(16);
    doc.setTextColor(255, 127, 80);
    doc.text('$0.70/mile', 14 + boxWidth + (boxWidth - 4) / 2, boxY + 26, { align: 'center' });
    ...
    const tripData = filteredTrips.map(trip => {
      ...
      return [
        ...
        formatCurrency((trip.totalMiles || 0) * 0.70)
      ];
    });
        ...
        <div style="display: flex; align-items: start; gap: 12px;">
          ...
          <div>
            ...
            <div style="font-size: 13px; color: #374151; line-height: 1.5;">
              ...
              <br/>
              <span style="color: #059669;">✓ Standard Mileage ($0.70/mile)</span> - Deduct mileage ONLY
              <br/>
      ...
      <div class="export-preview">
        ...
        <div class="preview-item highlight">
          ...
          <div class="preview-value">
            {formatCurrency(
              (filteredTrips.reduce((sum, t) => sum + (t.totalMiles || 0), 0) * 0.70) +
