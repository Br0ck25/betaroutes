<script lang="ts">
  ...
  let activeCategoryType: 'maintenance' | 'supplies' | 'expenses' = $state('maintenance');
  let settingsInitialTab: 'defaults' | 'categories' = $state('defaults');
...
<div class="expense-form-page">
  ...
  <div class="form-card">
          ...
          <div class="add-row">
            ...
            {:else}
              <button
                ...
                onclick={() => (formData.category = selectedMaintenance)}
        ...
        <div class="section-group">
          ...
          <div class="add-row">
            ...
            {:else}
              <button
                class="btn-small primary"
                onclick={() => (formData.category = selectedSupply)}
        ...
        <div class="section-group">
          ...
          <div class="add-row">
            ...
            {:else}
              <button
                class="btn-small primary"
                onclick={() => (formData.category = selectedExpense)}
    ...
    <div class="form-actions">
      ...
      <button class="btn-primary" onclick={saveExpense}>Save Changes</button>
    </div>
  </div>
</div>
