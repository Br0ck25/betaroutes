<script lang="ts">
  // ... (Imports and setup remain same as previously updated)
  ...
  // ... (loadTripData, tripData, helpers remain same) ...
  // (Assuming identical implementation to my previous response, skipping to saveTrip)
  ...
  // ... (handleOptimize, handleStopChange, handleMainAddressChange, handleNewStopSelect, addStop, removeStop, drag helpers, expense helpers, modal helpers, calculations) ...
  // NOTE: Inserting the updated handleOptimize and addStop to enforce limits consistently
  ...
  // [!code change] Update logic to catch Plan Limit errors
  async function saveTrip() {
    ...
    try { 
        ...
        // Check for Plan Limit / Stop Limit
