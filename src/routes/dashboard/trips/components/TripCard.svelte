<script lang="ts">
    import { formatCurrency, formatDate, formatTime, formatDuration, calculateNetProfit, calculateHourlyPay } from '$lib/utils/trip-helpers';
    ...
    function handleEdit() { dispatch('edit', trip.id); }
    function handleDelete() { dispatch('delete', trip.id); }
    function handleExpand() { dispatch('toggleExpand', trip.id); }
    function handleSelection() { dispatch('toggleSelection', trip.id); }
