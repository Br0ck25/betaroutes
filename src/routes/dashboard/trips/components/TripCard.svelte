  ...
  >
    ...
    <div class="card-stats">
      <div class="stat-item">
        ...
        <span class="stat-value">{(displayMiles() ?? 0).toFixed(2) || '0.00'}</span>
      </div>
      <div class="stat-item">
    ...
    {#if isExpanded}
      <div class="expanded-details" role="group">
        ...
        <div class="action-buttons-footer">
          ...
          <button
            class="action-btn-lg delete-btn"
            onclick={(e) => {
              e.stopPropagation();
              handleDelete();
            }}
