<script lang="ts">
  ...
  interface Props {
    ...
    startDate?: string;
    endDate?: string;
    filterProfit?: 'all' | 'positive' | 'negative';
    sortBy?: 'date' | 'profit' | 'miles';
    sortOrder?: 'asc' | 'desc';
  }
...
<div class="filters-bar">
  ...
  <div class="filter-group">
    ...
    <button class="sort-btn" aria-label="Toggle sort order" onclick={toggleSortOrder}>
      <svg
        width="20"
        height="20"
        viewBox="0 0 20 20"
