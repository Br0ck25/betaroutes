...
<svelte:head>
  ...
  <meta name="description" content="API documentation, user guides, and FAQs for Go Route Yourself." />
</svelte:head>
    ...
    <div class="docs-layout">
      ...
      <main class="content">
        <div class="page-header">
          <h1>Documentation</h1>
          <p>Everything you need to manage your routes, track profits, and integrate with our platform.</p>
        </div>

        <section id="getting-started" class="doc-section">
          <h2>Getting Started</h2>
          <p>
            Go Route Yourself helps drivers plan efficient routes and track their net profit in real-time. 
            To begin, create an account and set your default values (MPG, Gas Price) in the 
            <a href="/dashboard/settings">Settings</a> menu.
          </p>
        </section>
        ...
        <section id="profit-tracking" class="doc-section">
          ...
          <p>
            Unlike standard GPS apps, we focus on your bottom line. Here is how we calculate your "True Profit":
          </p>
          <div class="info-box">
          ...
          <ul>
            ...
            <li><strong>Fuel:</strong> Calculated automatically based on your vehicle's MPG and local gas prices, or entered manually.</li>
            <li><strong>Maintenance:</strong> Log oil changes, repairs, or set a "per-mile" wear-and-tear cost.</li>
          </ul>
        </section>
        ...
        <section id="exporting" class="doc-section">
          ...
          <p>
            You can export your data for tax purposes or team reporting.
          </p>
          <ol>
            <li>Navigate to <strong>Settings > Data Management</strong>.</li>
            <li>Choose <strong>Export All Trips (CSV)</strong> for a spreadsheet compatible with Excel/Google Sheets.</li>
            <li>For a visual summary, use the <strong>Print/PDF</strong> button on the Dashboard.</li>
          </ol>
        </section>
        ...
        <section id="authentication" class="doc-section">
          ...
          <p>
            The Go Route Yourself API allows Business Plan users to integrate route data directly into their own systems.
...
&#125;</pre>
        ...
        <section id="faq" class="doc-section">
          ...
          <div class="faq-item">
            ...
            <p>We use the Google Maps API for high-accuracy routing. However, actual mileage may vary slightly due to road detours or GPS drift.</p>
          </div>

          <div class="faq-item">
            <h4>Can I cancel my subscription?</h4>
            <p>Yes, you can cancel anytime from the Settings page. Your data will be preserved for 30 days in case you decide to return.</p>
          </div>

          <div class="faq-item">
            <h4>Do you support team accounts?</h4>
            <p>Yes! The Business Plan allows you to add multiple drivers and view a consolidated dashboard of all fleet earnings.</p>
          </div>
        </section>
